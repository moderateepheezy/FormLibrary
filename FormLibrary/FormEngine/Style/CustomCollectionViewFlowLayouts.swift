...
/**
 ** A custom flow layout for aligning
 ** collection view items base on ratio
**/

class CustomCollectionViewFlowLayout: UICollectionViewFlowLayout {
    
    class AlignTopFlowLayoutRowInfo: NSObject {
    ...
    override func layoutAttributesForElements(in rect: CGRect) -> [UICollectionViewLayoutAttributes]? {
        ...
        var rowInfos = [AlignTopFlowLayoutRowInfo]()
        ...
        for attributes in attributesCopy {
            ...
            if !found {
                let rowInfo = AlignTopFlowLayoutRowInfo()
